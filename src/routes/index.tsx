  ...
  head: () => ({
    meta: [
      { title: "Maximus Care" },
      {
        name: "description",
        content:
          "Sri Lanka's trusted physiotherapy & rehabilitation centre. Stroke, neurological, inpatient, sports & home-visit care. 5000+ patients, 4 branches.",
      },
      { property: "og:title", content: "Maximus Care — Physiotherapy & Rehabilitation Sri Lanka" },
      {
        property: "og:description",
        content: "Helping patients recover, regain independence and rebuild their lives.",
      },
        ...
        <div className="container mx-auto relative px-6 pt-16 pb-24 md:pt-24 md:pb-32 grid lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-up">
            ...
            <h1 className="mt-5 text-4xl md:text-6xl lg:text-7xl font-bold leading-[1.05] text-balance">
              Sri Lanka's Trusted <span className="text-accent">Physiotherapy</span> &
              Rehabilitation Centre
            </h1>
            <p className="mt-6 text-lg md:text-xl text-primary-foreground/85 max-w-xl leading-relaxed">
              Helping patients recover, regain independence and rebuild their lives through advanced
              physiotherapy, rehabilitation and personalised care.
            </p>
            ...
            <div className="mt-10 flex flex-wrap gap-6 text-sm text-primary-foreground/80">
              <div>
                <strong className="text-3xl block text-white">5000+</strong>Patients Treated
              </div>
              <div>
                <strong className="text-3xl block text-white">10,000+</strong>Treatment Sessions
              </div>
              <div>
                <strong className="text-3xl block text-white">4</strong>Branches
              </div>
            </div>
          </div>
          <div className="relative animate-fade-up">
            ...
            <img
              src={heroImg}
              alt="Physiotherapist helping elderly patient walk between parallel bars in rehabilitation gym"
            ...
            <div className="absolute -bottom-6 -left-6 bg-white text-foreground rounded-2xl shadow-card p-4 flex items-center gap-3 max-w-[260px] animate-float">
              <div className="grid place-items-center h-12 w-12 rounded-xl bg-success/15 text-success">
                <Heart className="h-6 w-6" />
              </div>
              <div className="text-sm">
                <strong className="block">Long-Term Recovery</strong>
                <span className="text-muted-foreground">Patient-centred care</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            >
              ...
              <p className="absolute bottom-3 left-4 right-4 text-white font-semibold text-sm md:text-base">
                {label as string}
              </p>
            </div>
          ))}
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-3 text-3xl md:text-5xl font-bold text-balance">
              Comprehensive rehabilitation built around every patient
            </h2>
            <p className="mt-4 text-muted-foreground text-lg">
              Twelve reasons families across Sri Lanka trust Maximus Care with their most important
              recovery journeys.
            </p>
          </div>
          <div className="mt-12 grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {WHY.map((w, i) => {
              ...
              return (
                <div
                  key={w}
                  className="group flex items-start gap-4 rounded-2xl border border-border bg-card p-6 shadow-soft hover:shadow-card hover:-translate-y-1 transition-all"
                >
      ...
      <section className="py-20 md:py-28">
        <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-14 items-center">
          <div className="relative">
            <img
              src={facilityImg}
              alt="Modern physiotherapy and rehabilitation facility"
              loading="lazy"
              className="rounded-3xl shadow-card aspect-[4/3] object-cover w-full"
            />
            <div className="absolute -bottom-6 -right-6 hidden md:block bg-primary text-primary-foreground rounded-2xl p-6 shadow-glow max-w-[220px]">
              ...
              <p className="text-sm text-primary-foreground/80 mt-1">
                years of dedicated physiotherapy service
              </p>
            </div>
          </div>
          <div>
            ...
            <h2 className="mt-3 text-3xl md:text-5xl font-bold text-balance">
              A physiotherapy home built on healing, dignity and science.
            </h2>
            <p className="mt-5 text-muted-foreground text-lg leading-relaxed">
              Maximus Care Physio & Rehab Unit (Pvt) Ltd is a leading physiotherapy and
              rehabilitation provider dedicated to helping patients recover from neurological
              conditions, stroke, surgery, sports injuries, chronic pain, and mobility limitations.
            </p>
            <p className="mt-4 text-muted-foreground leading-relaxed">
              Our mission is to deliver affordable, evidence-based physiotherapy and rehabilitation
              that restores independence, improves quality of life, and supports long-term recovery.
            </p>
            <ul className="mt-6 grid sm:grid-cols-2 gap-3">
              {[
                ...
                <li key={x} className="flex items-start gap-2 text-sm">
                  <CheckCircle2 className="h-5 w-5 text-success shrink-0" /> {x}
                </li>
              ))}
            </ul>
            <Link
        ...
        <div className="container mx-auto px-6">
          <div className="flex items-end justify-between gap-6 flex-wrap mb-12">
            <div className="max-w-2xl">
              ...
              <h2 className="mt-3 text-3xl md:text-5xl font-bold">
                20 specialised physiotherapy & rehabilitation therapies under one roof
              </h2>
            </div>
            <Link
              to="/services"
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {SERVICES.slice(0, 8).map(([title, desc]) => (
              <div
                key={title}
                className="group rounded-2xl bg-card p-6 shadow-soft hover:shadow-card transition-shadow border border-transparent hover:border-primary/20"
              >
      ...
      <section className="py-20 md:py-28 bg-gradient-hero text-primary-foreground relative overflow-hidden">
        ...
        <div className="container mx-auto relative px-6 grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="mt-3 text-3xl md:text-5xl font-bold text-balance">
              Dedicated Inpatient Rehabilitation for Faster Recovery
            </h2>
            <p className="mt-5 text-lg text-primary-foreground/85 leading-relaxed">
              Our inpatient program is built for patients who need intensive therapy and
              round-the-clock monitoring — with structured plans, multiple daily sessions and a
            ...
            <div className="mt-8 grid sm:grid-cols-2 gap-3">
              {[
                ...
                "One caregiver may stay",
                "Daily meals included",
                "Home transition planning",
              ].map((x) => (
                <div key={x} className="flex items-start gap-2 text-primary-foreground/90 text-sm">
                  <CheckCircle2 className="h-5 w-5 text-accent shrink-0" /> {x}
                </div>
              ))}
            </div>
            <Link
              to="/inpatient"
              className="mt-8 inline-flex items-center gap-2 rounded-full bg-white text-primary px-6 py-3 font-semibold hover:bg-white/90 transition-colors"
            >
          ...
          <div className="relative">
            <img
              src={inpatientImg}
              alt="Modern inpatient rehabilitation room"
              loading="lazy"
              className="rounded-3xl shadow-glow aspect-[4/3] object-cover w-full"
            />
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 text-center">
            {STATS.map(([n, l]) => (
              <div
                key={l}
                className="rounded-2xl bg-gradient-soft border border-border p-6 shadow-soft"
              >
                <p className="text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-primary bg-clip-text text-transparent">
                  {n}
                </p>
      ...
      <section className="py-20 md:py-28 bg-secondary">
        <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
          <img
            ...
            loading="lazy"
            className="rounded-3xl shadow-card aspect-[4/3] object-cover w-full order-2 lg:order-1"
          />
          <div className="order-1 lg:order-2">
            ...
            <h2 className="mt-3 text-3xl md:text-5xl font-bold text-balance">
              Professional Physiotherapy & Rehabilitation at Your Home
            </h2>
            <p className="mt-5 text-muted-foreground text-lg">
              For patients who cannot travel, our therapists bring world-class rehabilitation
            ...
            <ul className="mt-6 grid sm:grid-cols-2 gap-2 text-sm">
              {[
                ...
                "Post-Surgical Recovery",
                "Pain Management",
                "Wheelchair Patient Rehab",
                "Home Exercise Programs",
                "Long-Term Support",
              ].map((x) => (
                <li key={x} className="flex items-start gap-2">
                  <Waves className="h-4 w-4 text-primary mt-0.5 shrink-0" /> {x}
                </li>
              ))}
            </ul>
            <a
              href={`tel:${SITE.phoneIntl}`}
              className="mt-8 inline-flex items-center gap-2 rounded-full bg-gradient-primary text-primary-foreground px-6 py-3 font-semibold shadow-soft hover:shadow-glow transition-all"
            >
              <Phone className="h-4 w-4" /> Request a Home Visit
            </a>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {TESTIMONIALS.slice(0, 6).map((t) => (
              <figure
                key={t.name}
                className="rounded-2xl bg-card border border-border p-7 shadow-soft hover:shadow-card transition-shadow"
              >
                <div className="flex gap-0.5 text-accent">
      ...
      <section className="py-20 md:py-28 bg-gradient-soft">
        <div className="container mx-auto px-6">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <h2 className="mt-3 text-3xl md:text-5xl font-bold">
              Quality physiotherapy & rehabilitation, close to home
            </h2>
          </div>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {BRANCHES.map((b) => (
              <div
                key={b.slug}
                className="rounded-2xl bg-card border border-border p-6 shadow-soft hover:shadow-card transition-all hover:-translate-y-1"
              >
      ...
      <section className="py-20 bg-primary text-primary-foreground">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="mt-4 text-primary-foreground/85 max-w-xl mx-auto">
            Speak directly with our physiotherapy team. We will guide you through the right program
            for your needs.
          </p>
          <div className="mt-8 flex flex-wrap gap-3 justify-center">
            <a
              href={`tel:${SITE.phoneIntl}`}
              className="inline-flex items-center gap-2 rounded-full bg-gradient-accent text-accent-foreground px-7 py-3.5 font-semibold shadow-glow"
            >
              <Phone className="h-5 w-5" /> Call {SITE.phone}
            </a>
            <a
              href={`https://wa.me/${SITE.whatsapp}`}
              className="inline-flex items-center gap-2 rounded-full bg-white text-primary px-7 py-3.5 font-semibold"
            >
